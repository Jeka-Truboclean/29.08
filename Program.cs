...
namespace _29._08
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Player1: Press Enter to throw dice");
            Console.ReadLine();
            int res1 = RollDice().Result;
            ShowDice(res1);
            Console.WriteLine("Player2: Press Enter to throw dice");
            Console.ReadLine();
        ...
        {
            Console.WriteLine("Player: Press Enter to throw dice");
            Console.ReadLine();
            int res1 = RollDice().Result;
            ShowDice(res1);
            Thread.Sleep(1000);
